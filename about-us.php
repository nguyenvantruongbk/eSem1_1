        ...
        <div class="container">
            <div class="wsus__about_accordian">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <img src="images/About-us.jpg" alt="img" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-3">
                        <div class="wsus__about_award_single">
                            <img src="images/About-us2.jpg" alt="logo" class="img-fluid w-100">
                            <p>Smart Home Led City</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 col-lg-3">
                        <div class="wsus__about_award_single">
                            <img src="images/About-us3.jpg" alt="logo" class="img-fluid w-100">
                            <p>Mubai Accomodation luxury</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 col-lg-3">
                        <div class="wsus__about_award_single">
                            <img src="images/About-us4.jpg" alt="logo" class="img-fluid w-100">
                            <p>Nothent City</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 col-lg-3">
                        <div class="wsus__about_award_single">
                            <img src="images/About-us5.jpg" alt="logo" class="img-fluid w-100">
